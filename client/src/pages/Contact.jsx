        ...
        <div className='flex flex-col items-center justify-center lg:flex-row gap-16'>
          ...
          <div className='lg:w-1/2 bg-white p-8 rounded-xl shadow-lg border border-gray-100'>
            <div className='mb-8'>
              ...
              <p className='text-gray-600 mb-2'>251306 Pinna, Muzaffar Nagar</p>
        ...
        <div className='mt-20 grid grid-cols-1 md:grid-cols-2 gap-10'>
          ...
          <div className='bg-white p-6 rounded-xl shadow-lg border border-gray-100'>
            ...
            <div className='aspect-w-16 aspect-h-9 rounded-lg overflow-hidden border-2 border-white shadow-md'>
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3474.042223811796!2d77.7112932733732!3d29.45677734219629!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390c1b1b117345eb%3A0x702b67b6816b0b00!2sPinna%2C%20Muzaffarnagar%2C%20Uttar%20Pradesh%20251001!5e0!3m2!1sen!2sin!4v1766177462043!5m2!1sen!2sin%22%20width=%22400%22%20height=%22300%22%20style=%22border:0;%22%20allowfullscreen=%22%22%20loading=%22lazy%22%20referrerpolicy=%22no-referrer-when-downgrade" 
                width="100%" 
                height="300" 
                style={{border:0}} 
                allowFullScreen="" 
