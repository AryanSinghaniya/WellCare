...
console.log('Razorpay configured with key:', process.env.RAZORPAY_KEY_ID ? process.env.RAZORPAY_KEY_ID.substring(0, 10) + '...' : 'NOT SET')
...
const forgotPassword = async (req, res) => {
    try {
        ...
        // Frontend URL (Client is on 5174 based on vite.config.js)
