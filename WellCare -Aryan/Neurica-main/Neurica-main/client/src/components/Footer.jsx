...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-b from-white to-blue-50 pt-16 pb-8 px-6 md:px-10 border-t border-gray-100">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-start">
                                ...
                                <div>
                                    <p className="text-gray-700 font-medium">hello@wellcare.com</p>
                            ...
                            <li className="flex items-start">
                                ...
                                <div>
                                    <p className="text-gray-700 font-medium">251306 Pinna, Muzaffar Nagar</p>
                                    <p className="text-sm text-gray-500 mt-1">Uttar Pradesh, India</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-gray-200 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-500 text-sm mb-4 md:mb-0">
                            &copy; {new Date().getFullYear()} WellCare. All rights reserved.
                        </p>
                        ...
                        <p className="text-gray-500 text-sm mt-4 md:mt-0">
                            ...
                            <a
                                href="https://www.linkedin.com/in/aryan-singhaniya-164a6a269/"
