...
const staffLoginUrl = import.meta.env.VITE_ADMIN_URL || "http://localhost:5173";
    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="hidden md:block bg-gradient-to-r from-blue-800 to-green-400 text-white text-sm py-2 px-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex space-x-6">
            ...
            <div className="flex items-center space-x-1"><FaMapMarkerAlt size={12} /><span>251306 Pinna, Muzaffar Nagar, Uttar Pradesh, India</span></div>
          </div>
      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center cursor-pointer" onClick={() => navigate("/")}>
          <img src={assets.logo} alt="WellCare Logo" className="h-10 mr-2" />
          <span className="text-2xl font-bold text-blue-800">WellCare</span>
        </div>
      ...
      <div className={`md:hidden fixed top-0 left-0 w-72 h-full z-50 bg-white transform transition-transform duration-300 shadow-2xl ${showMenu ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex justify-between items-center p-4 border-b border-gray-200">
          <div className="flex items-center cursor-pointer" onClick={() => { navigate("/"); setShowMenu(false); }}>
            <img src={assets.logo} alt="WellCare Logo" className="h-8 mr-2" />
            <span className="text-xl font-bold text-blue-800">WellCare</span>
          </div>
